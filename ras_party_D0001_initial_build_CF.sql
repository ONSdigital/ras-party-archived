...
--
DROP TABLE IF EXISTS ras_respondents CASCADE;

-- CREATE TABLE ras_respondents
-- (id             BIGSERIAL                 NOT NULL
...
--
DROP TABLE IF EXISTS ras_business_associations CASCADE;

CREATE TABLE ras_business_associations
(id              BIGSERIAL                 NOT NULL
...
,CONSTRAINT ras_bua_bus_fk
   FOREIGN KEY (business_id)
     REFERENCES ras_businesses(id)
,CONSTRAINT ras_bua_res_fk
   FOREIGN KEY (respondent_id)
     REFERENCES ras_respondents(id)
,CONSTRAINT valid_status
...
--
CREATE INDEX ras_bua_bus_fk_idx ON ras_business_associations(business_id);

--
-- Index: ras_bua_res_fk_idx - FK Index
--
CREATE INDEX ras_bua_res_fk_idx ON ras_business_associations(respondent_id);

--
-- Index: ras_bua_surveyid_idx
--
--CREATE INDEX ras_bua_surveyid_idx ON ras_business_associations(surveyid);

--
-- Table: ras_enrolments [ENR]
--
DROP TABLE IF EXISTS ras_enrolments CASCADE;

CREATE TABLE ras_enrolments
(id                       BIGSERIAL                 NOT NULL
...
,CONSTRAINT ras_bua_res_fk
   FOREIGN KEY (business_association_id)
     REFERENCES ras_business_associations(id)
,CONSTRAINT valid_status
...
--
CREATE INDEX ras_enr_bua_fk_idx ON ras_enrolments(business_association_id);

--
-- Index: ras_enr_survey_id_idx
--
CREATE INDEX ras_enr_survey_id_idx ON ras_enrolments(survey_id);

--
-- Table: ras_enrolment_codes [ENC]
--
DROP TABLE IF EXISTS ras_enrolment_codes CASCADE;

CREATE TABLE ras_enrolment_codes
(id                       BIGSERIAL                 NOT NULL
...
--
DROP TABLE IF EXISTS ras_enrolment_invitations CASCADE;

CREATE TABLE ras_enrolment_invitations
(id                       BIGSERIAL                 NOT NULL
,respondent_id            CHARACTER VARYING (255)   NOT NULL
...
INSERT INTO ras_business_associations
